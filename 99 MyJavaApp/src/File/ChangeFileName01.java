...
public class ChangeFileName01 {
	private static final String ENCD = "utf-8";
	static int count=0;
	public static void main(String args[]) throws FileNotFoundException {
		try {
//			getFile("D:/project/AttFile/dwld");
			
//			File tableFile = new File("D:/project/logs/T_LIST_0424.txt");
			
			File rscFile = new File("D:/project/AttFile/rsc.txt");
			File fnFile = new File("D:/project/AttFile/fn.txt");
...
//			Scanner scnrLog = new Scanner(logFile, ENCD);
			...
			Scanner scnrRsc = new Scanner(rscFile, ENCD);
			Scanner scnrFn = new Scanner(fnFile, ENCD);
			
			ArrayList<String> myArray = new ArrayList<>();
			SortedSet ts = new TreeSet();
			int a=0;
			while(scnrRsc.hasNextLine()) {
				a++;
//				String nextTokenRsc = scnrRsc.next();
//				String nextTokenFn = scnrFn.next();
				String nextLineRsc = scnrRsc.nextLine();
				String nextLineFn = scnrFn.nextLine();
//				System.out.println(a  + " : " + nextLineFn);
				changeFileName(nextLineRsc, nextLineFn);
			}
...
//			}
	...
	private static void changeFileName(String rsc, String fn) {
		File f = new File("D:/project/AttFile/dwld/all_files");
...
//				String fileName = file.getName().toUpperCase();
				...
				if(fileName.equals(rsc)) {
					file.renameTo(new File("D:/project/AttFile/dwld/to/" + fn));
					System.out.println(rsc + " ----> " +fn);
				}
